...
module.exports = function (environment) {
    var ENV = {
        ...
        APP: {
            // API host and port
            ApiUrl: '//INTERNET_IP_OR_DNS/',

            // HTTP mining endpoint
            HttpHost: 'INTERNET_IP_OR_DNS',
            HttpPort: 40002,

            // Stratum mining endpoint
            StratumHost: 'INTERNET_IP_OR_DNS',
            StratumPort: 9009,

            NicehashHost: 'INTERNET_IP_OR_DNS',
            NicehashPost: 40004,
            ...
            WebsiteName: 'INTERNET_IP_OR_DNS',
    ...
    if (environment === 'development') {
         ...
         */
        ENV.APP.ApiUrl = 'https://INTERNET_IP_OR_DNS/'
